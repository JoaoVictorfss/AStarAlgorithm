...
print(primeiro.matriz, primeiro.movimento)
segundo = borda.obter_primeiro_no()
print(segundo.matriz, segundo.movimento)
terceiro = borda.obter_primeiro_no()
print(terceiro.matriz, terceiro.movimento)
quarto = borda.obter_primeiro_no()
print(quarto.matriz, quarto.movimento)
